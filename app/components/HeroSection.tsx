...
const AnimatedLogoPlaceholder: React.FC = () => (
  <div className="w-48 h-48 md:w-64 md:h-64 rounded-full flex items-center justify-center text-center p-4">
...
const HeroSection: React.FC = () => {
  return (
    <section 
      id="hero"
      className="min-h-screen flex flex-col items-center justify-center relative text-center p-6 bg-primary-neutral"
    >
